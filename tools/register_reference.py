...
BEHAVIORAL_NOTES: tuple[BehavioralNote, ...] = (
    BehavioralNote(
        ...
        safety_note=(
            ...
            "the 8200i SE (PR #52).\n\n"
            "UPDATE (2026-09-06): real-hardware-tested on the 8100 V2 at the "
            "equivalent settings (7200/1800/900ppi, n_brackets=3, Forensic-tab "
            "recorded) — neither fault reproduced. All runs completed "
            "successfully, output visually clean, no unusual motor sound. The "
            "pixel-clock pairing flagged above (intermediate-exposure bracket "
            "getting the full 'long' clock) is confirmed to actually occur "
            "(decoded_events.jsonl, both 1800 and 7200dpi runs) but did not "
            "fault V2. This does not clear the 8200i SE side of PR #52 — a "
            "non-reproduction on a different model's hardware doesn't explain "
            "or rule out the SE's fault. See "
            "docs/hw-ref/n-bracket-me-investigation.md Phase 3 for the full "
            "run table. Still treat n_brackets>2 on the 8200i SE as needing "
            "its own real-hardware confirmation before trusting it there."
        ),
    ),
    BehavioralNote(
